...
const updateOptions = {
    gitRepo: "hello", // [Required] Your Repo Name
    gitUsername: "bashgaa",  // [Required] Your GitHub Username.

    appName: "electron-tutorial-app", //[Required] The Name of the app archive and the app folder.
    appExecutableName: "electron-tutorial-app.exe", //[Required] The Executable of the Application to be Run after updating.
